...
const sendMarsTemperature = (callback1, callback2) => {
  ...
  setTimeout(() => ((chance())
    ...
    : callback2(errorMsg)), messageDelay());
};

// imprime "It is currently 47ºF at Mars", por exemplo, ou
// "Error getting temperature: Robot is busy"
sendMarsTemperature(temperatureInFahrenheit, handleError);

// imprime "Hi there! Curiosity here. Right now is 53ºC at Mars", por exemplo,
// ou "Error getting temperature: Robot is busy"
